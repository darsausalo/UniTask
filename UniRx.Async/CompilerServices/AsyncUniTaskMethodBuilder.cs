...
namespace UniRx.Async.CompilerServices
{
    public struct AsyncUniTaskMethodBuilder
    {
        ...
        public UniTask Task
        {
            get
            {
                ...
                if (moveNext == null) return UniTask.CompletedTask;
        ...
        {
            if (promise == null) promise = new UniTaskCompletionSource();
            ...
            where TStateMachine : IAsyncStateMachine
        {
            if (moveNext == null)
            {
                if (promise == null) promise = new UniTaskCompletionSource(); // built future.
    ...
    public struct AsyncUniTaskMethodBuilder<T>
    {
        ...
        public UniTask<T> Task
        {
            get
            {
                if (promise != null) return new UniTask<T>(promise);

                if (moveNext == null) return new UniTask<T>(result);
        ...
        public void SetException(Exception exception)
        {
            if (promise == null) promise = new UniTaskCompletionSource<T>();
            if (exception is OperationCanceledException ex)
                promise.TrySetCanceled(ex);
            else
                promise.TrySetException(exception);
            ...
            where TStateMachine : IAsyncStateMachine
        {
            if (moveNext == null)
            {
                if (promise == null) promise = new UniTaskCompletionSource<T>(); // built future.
